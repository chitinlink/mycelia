...
tzlist = {
  ...
  "-05":    { "ACT", "CDT", "COT", "CST", "EASST", "ECT", "EST", "PET" },
  "-04":    { "AMT", "AST", "BOT", "CDT", "CLT", "COST", "ECT", "EDT", "FKT", "GYT", "PYT", "VET" },
  "-03:30": { "NST", "NT" },
  "-03":    { "ADT", "AMST", "ART", "BRT", "CLST", "FKST", "GFT", "PMST", "PYST", "ROTT", "SRT", "UYT", "WGT" },
  "-02:30": { "NDT" },
  "-02":    { "BRST", "FNT", "GST", "PMDT", "UYST", "WGST" },
  "-01":    { "AZOT", "CVT", "EGT" },
  "+0":     { "AZOST", "EGST", "GMT", "UTC", "WET" },
  "+01":    { "BST", "CET", "DFT", "IST", "MET", "WAT", "WEST" },
  "+02":    { "CAT", "CEST", "EET", "HAEC", "IST", "KALT", "MEST", "SAST", "WAST" },
  ...
  "+05:30": { "IST", "SLST" },
  "+05:45": { "NPT" },
  "+06":    { "ALMT", "BIOT", "BST", "BTT", "KGT", "OMST", "VOST" },
  "+06:30": { "CCT", "MMT" },
  "+07":    { "CXT", "DAVT", "HOVT", "ICT", "KRAT", "NOVT", "THA", "WIT" },
  "+08":    { "AWST", "BDT", "CHOT", "CIT", "CST", "CT", "HKT", "HOVST", "IRKT", "MST", "MYT", "PHT", "PST", "SGT", "SST", "ULAT", "WST", "AWST" },
  "+08:45": { "ACWST", "CWST" },
  "+09":    { "CHOST", "EIT", "JST", "KST", "TLT", "ULAST", "YAKT" },
  "+09:30": { "ACST", "ACST" },
  "+10":    { "AEST", "CHST", "CHUT", "DDUT", "PGT", "VLAT", "AEST" },
  "+10:30": { "ACDT", "LHST" },
  "+11":    { "AEDT", "BST", "KOST", "LHST", "MIST", "NCT", "NFT", "PONT", "SAKT", "SBT", "SRET", "VUT" },
